...
function CommentsSection({
  ...
  const [gifSearching, setGifSearching] =
    useState(false);
  ...
  const searchGifs =
    async (
      ...
      if (!apiKey) {
        setError(
          "Configure VITE_GIPHY_API_KEY no Vercel para usar GIFs.",
        );
        return;
      }
  ...
  const handleComment =
    async () => {
      ...
      if (
        (!value && !commentImage && !selectedGifUrl) ||
        !animeId ||
        !episodeId ||
        sending ||
        imageUploading
      ...
      <div className="grid gap-8">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-5 rounded-xl border border-white/5 bg-surface p-4 sm:p-5">
            ...
            {(commentImagePreview || selectedGifUrl) && (
              <div className="relative mt-3 w-fit max-w-full overflow-hidden rounded-xl border border-white/10 bg-bg">
                ...
                <img
                  ...
                  alt={
                    selectedGifUrl
                      ? "Prévia do GIF do comentário"
                      : "Prévia da imagem do comentário"
                  }
            ...
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button
                ...
                disabled={
                  (!text.trim() && !commentImage && !selectedGifUrl) ||
                  sending ||
                  imageUploading
                }
              >
          ...
          {gifOpen && (
            <div className="mt-4 rounded-xl border border-white/5 bg-surface p-4 sm:p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-subtle">
                    Pesquise um GIF para adicionar ao comentário.
                  </p>
                </div>
                ...
                <button
                  ...
                  title="Fechar"
                  className="flex size-9 items-center justify-center rounded-lg text-muted transition-colors hover:bg-bg hover:text-fg"
                >
                  <X className="size-4" />
                </button>
              </div>
              ...
              >
                <input
                  ...
                  maxLength={50}
                  className="min-w-0 flex-1 rounded-lg border border-white/5 bg-bg px-3 py-2 text-sm text-fg outline-none placeholder:text-subtle focus:border-white/15"
                />

                <button
                  type="submit"
                  disabled={gifLoading || gifSearching}
                  aria-label="Buscar GIF"
                  title="Buscar GIF"
                  className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-white/5 bg-bg text-muted transition-colors hover:border-white/10 hover:bg-elevated hover:text-fg disabled:cursor-not-allowed disabled:opacity-50"
                >
              ...
              {gifLoading ? (
                <div className="mt-4 py-8 text-center text-sm text-subtle">
                  Carregando GIFs...
                </div>
              ) : gifs.length ? (
                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
                  {gifs.map((gif) => (
                    <button
                      ...
                      className="group relative overflow-hidden rounded-lg border border-white/5 bg-bg transition-transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/20"
                      title={gif.title || "Selecionar GIF"}
                    >
                      <img
                        src={gif.previewUrl}
                        alt={gif.title || "GIF"}
              ...
              <p className="mt-3 text-right text-[10px] text-subtle">
                Powered by GIPHY
              </p>
            </div>
          )}
